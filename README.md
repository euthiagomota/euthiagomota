...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=006CCD&size=30&center=true&vCenter=true&width=1000&lines=Hi+there,+My+name+is+Thiago+Mota;Information+System+Student;A+Backend+Developer;Be+Welcome!+:%29)](https://git.io/typing-svg)
...
![Minhas Stacks](https://skillicons.dev/icons?i=javascript,typescript,java,angular,sass,nodejs,nestjs,spring,maven,postgres,mysql,mongodb,docker,git,github,azure,npm,postman,vscode,idea&theme=dark&perline=12)
